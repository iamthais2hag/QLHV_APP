...
IF DB_NAME() <> N'CSDL_OTO_V1'
    THROW 527600, 'Wrong database. Expected CSDL_OTO_V1.', 1;
...
(
    ...
    THROW 527601, 'CSDL_OTO_V1 must be ONLINE and read-write.', 1;
...
BEGIN TRY
    ...
    VALUES
        (N'CK_QLHV_CsdtRealtimeMembership_Route',
         ...
         N'OTO_V1|OTO_V2|OTO_V2_TO_V1|66029',
        ...
        (N'CK_QLHV_CsdtRealtimeOwnershipClaim_Shape',
         ...
         N'OTO_V1|TYPED_OWNER_SQLSERVER_SQL_LATIN1_GENERAL_CP1_CI_AS_V1|DM_DonViGTVT|GiaoVien|KhoaHoc|KhoaHoc_GiaoVien|BaoCaoI|NguoiLX|NguoiLX_HoSo|NguoiLXHS_GiayTo',
        ...
        (N'CK_QLHV_CsdtRealtimeCoverage_Route',
         ...
         N'OTO_V1|OTO_V2|OTO_V2_TO_V1|66029|DM_DonViGTVT|GiaoVien|KhoaHoc|KhoaHoc_GiaoVien|BaoCaoI|NguoiLX|NguoiLX_HoSo|NguoiLXHS_GiayTo',
