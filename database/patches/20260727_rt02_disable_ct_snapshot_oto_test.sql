...
IF @ExpectedDatabase = N'EXACT_TEST_DB'
   ...
   OR @ExpectedDatabaseGuid IS NULL
    THROW 527310, 'RT02 rollback template placeholders are unresolved.', 1;
...
IF DB_NAME() <> @ExpectedDatabase
   ...
   OR
    ...
    THROW 527311, 'ISOLATED_DATABASE_IDENTITY_REJECTED: OTO rollback identity.', 1;
...
(
    ...
    THROW 527312, 'RT02 approved TEST markers are missing for OTO rollback.', 1;
GO
