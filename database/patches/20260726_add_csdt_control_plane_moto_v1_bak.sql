...
IF DB_NAME() <> N'CSDL_MOTO_V1_BAK'
    THROW 527600, 'Wrong database. Expected CSDL_MOTO_V1_BAK.', 1;
...
(
    ...
    THROW 527601, 'CSDL_MOTO_V1_BAK must be ONLINE and read-write.', 1;
...
BEGIN TRY
    ...
    IF OBJECT_ID(N'dbo.CK_QLHV_CsdtRealtimeMembership_Route', N'C') IS NULL
        ...
        (
            ...
            AND SourceProfile = 'MOTO_V2_BAK'
            AND StreamCode = 'MOTO_V2_TO_V1'
            AND MaCSDT = '66030'
        );
    ...
    VALUES
        (N'CK_QLHV_CsdtRealtimeMembership_Route',
         ...
         N'MOTO_V1_BAK|MOTO_V2_BAK|MOTO_V2_TO_V1|66030',
        ...
        (N'CK_QLHV_CsdtRealtimeOwnershipClaim_Shape',
         ...
         N'MOTO_V1_BAK|TYPED_OWNER_SQLSERVER_SQL_LATIN1_GENERAL_CP1_CI_AS_V1|DM_DonViGTVT|GiaoVien|KhoaHoc|KhoaHoc_GiaoVien|BaoCaoI|NguoiLX|NguoiLX_HoSo|NguoiLXHS_GiayTo',
        ...
        (N'CK_QLHV_CsdtRealtimeCoverage_Route',
         ...
         N'MOTO_V1_BAK|MOTO_V2_BAK|MOTO_V2_TO_V1|66030|DM_DonViGTVT|GiaoVien|KhoaHoc|KhoaHoc_GiaoVien|BaoCaoI|NguoiLX|NguoiLX_HoSo|NguoiLXHS_GiayTo',
        ...
        (N'CK_QLHV_CsdtRealtimeCheckpoint_Route',
         ...
         N'MOTO_V1_BAK|MOTO_V2_BAK|MOTO_V2_TO_V1',
